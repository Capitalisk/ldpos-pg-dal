...
describe('Integration tests', async () => {
    ...
    it('should initialise genesis accounts', async () => {
        ...
        const actualAccounts = sort(excludeNullPropertiesFromArr(await accountsRepo.getAccounts()), accounts.columns.address);
    ...
    it('should initialise genesis delegates', async () => {
        ...
        const actualDelegates = sort(excludeNullPropertiesFromArr(await delegatesRepo.getDelegates()), delegates.columns.address);
    ...
    it('should initialise genesis ballots', async () => {
        ...
        const actualBallots = sort(excludePropertyFromArr(await ballotsRepo.getBallots(), ballots.columns.id), ballots.columns.voterAddress);
    ...
    it('should initialise genesis multisig_memeberships', async () => {
        ...
        const actualMemberships = (await multisigMembershipsRepo.getMemberShips()).map(ms => ms[multisig_memberships.columns.memberAddress]);
