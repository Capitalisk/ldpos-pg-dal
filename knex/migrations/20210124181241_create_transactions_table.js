...
exports.up = function(knex) {
    return Promise.resolve(
        knex.schema.createTable(tableName, (tbl) => {
            ...
            tbl.string(table.field.recipientAddress, 80).nullable();
            ...
            tbl.string(table.field.senderAddress, 80).notNullable();
            tbl.string(table.field.sigPublicKey, 44).notNullable();
            tbl.string(table.field.nextSigPublicKey, 44).notNullable();
            ...
            tbl.string(table.field.blockId, 44).notNullable();
